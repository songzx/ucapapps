...
<body class="page-header-fixed">
	...
	<script src="media/image/js" type="text/javascript"></script>
	<script src="media/js/gmaps.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="media/js/app.js" type="text/javascript"></script>       
	<script src="media/js/maps-google.js" type="text/javascript"></script>
